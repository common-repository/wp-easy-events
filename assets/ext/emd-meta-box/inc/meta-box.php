...
if ( ! class_exists( 'EMD_Meta_Box' ) )
{
	...
	class EMD_Meta_Box
	{
		...
		{
			$jqvalid_msg['required'] = __('This field is required.','wp-easy-events');
			$jqvalid_msg['remote'] = __('Please fix this field.','wp-easy-events');
			$jqvalid_msg['email'] = __('Please enter a valid email address.','wp-easy-events');
			$jqvalid_msg['url'] = __('Please enter a valid URL.','wp-easy-events');
			$jqvalid_msg['date'] = __('Please enter a valid date.','wp-easy-events');
			$jqvalid_msg['dateISO'] = __('Please enter a valid date ( ISO )','wp-easy-events');
			$jqvalid_msg['number'] = __('Please enter a valid number.','wp-easy-events');
			$jqvalid_msg['digits']= __('Please enter only digits.','wp-easy-events');
			$jqvalid_msg['creditcard']= __('Please enter a valid credit card number.','wp-easy-events');
			$jqvalid_msg['equalTo']= __('Please enter the same value again.','wp-easy-events');
			$jqvalid_msg['maxlength']= __('Please enter no more than {0} characters.','wp-easy-events');
			$jqvalid_msg['minlength']= __('Please enter at least {0} characters.','wp-easy-events');
			$jqvalid_msg['rangelength']= __('Please enter a value between {0} and {1} characters long.','wp-easy-events');
			$jqvalid_msg['range']= __('Please enter a value between {0} and {1}.','wp-easy-events');
			$jqvalid_msg['max']= __('Please enter a value less than or equal to {0}.','wp-easy-events');
			$jqvalid_msg['min']= __('Please enter a value greater than or equal to {0}.','wp-easy-events');
		...
		function show()
		{
			...
			if(isset( $this->validation ) && $this->validation){
				echo '
					...
					summaryMessage : "' . __( 'Please correct the errors highlighted below and try again.', 'wp-easy-events' ) . '",';
			}
