...
class EmdScbOptions {
	...
	public function __construct( $key, $file, $defaults = array() ) {
		...
		if ( $file ) {
			EmdScbUtil::add_activation_hook( $file, array( $this, '_activation' ) );
			EmdScbUtil::add_uninstall_hook( $file, array( $this, 'delete' ) );
		}
	}
	...
	public function get( $field = null, $default = null ) {
		...
		return EmdScbForms::get_value( $field, $data, $default );
	}
	...
	public function get_defaults( $field = null ) {
		return EmdScbForms::get_value( $field, $this->defaults );
	}
