...
/**
 * A Emd_Mustache Partial filesystem loader.
 *
 * @author Justin Hileman {@link http://justinhileman.com}
 */
class Emd_MustacheLoader implements ArrayAccess {
	...
	/**
	 * Emd_MustacheLoader constructor.
	 *
	 * @access public
	 * @param  string $baseDir   Base template directory.
	 * @param  string $extension File extension for Emd_Mustache files (default: 'mustache')
	 * @return void
	 */
	...
	/**
	 * Emd_MustacheLoader is an immutable filesystem loader. offsetSet throws a LogicException if called.
	 *
	 * @throws LogicException
	 * @return void
	 */
	public function offsetSet($offset, $value) {
		throw new LogicException('Unable to set offset: Emd_MustacheLoader is an immutable ArrayAccess object.');
	}
	
	/**
	 * Emd_MustacheLoader is an immutable filesystem loader. offsetUnset throws a LogicException if called.
	 *
	 * @throws LogicException
	 * @return void
	 */
	public function offsetUnset($offset) {
		throw new LogicException('Unable to unset offset: Emd_MustacheLoader is an immutable ArrayAccess object.');
	}
