...
if (!function_exists('emd_display_store')) {
	...
	<p><?php esc_html_e('The following plugins extend and expand the functionality of your app.','wp-easy-events'); ?></p>
...
if (!function_exists('emd_display_review')) {
	...
	<div class="plugin-review-text"><a href="https://wordpress.org/support/view/plugin-reviews/<?php echo esc_attr($plugin); ?>" target="_blank"><?php esc_html_e('Like our plugin? Leave us a review','wp-easy-events'); ?></a>
