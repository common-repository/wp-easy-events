...
'><?php esc_html_e('More info', 'wp-easy-events'); ?></a></div>
                                <?php
} ?>
...
if (emd_mb_meta('emd_event_registration_type') == 'rsvp') {
	...
	echo wp_kses($modal_content, $allowed);
...
?>
<div class="single-relpanel emd-event-organizer event-organizer"><div class="accor-title"><?php esc_html_e('Organizers', 'wp-easy-events'); ?></div>  <?php
...
<a href="<?php echo esc_url(get_permalink($post->ID)); ?>" title="<?php echo get_the_title(); ?>"><?php echo get_the_title(); ?></a>
</li>
<?php if (emd_is_item_visible('featured_img', 'wp_easy_events', 'attribute', 0)) { ?>
<li class=" relseg">
<div style="padding-bottom:0" class="featured-img segment-block">
<div class="segtitle" style="margin-bottom:0;"></div>
<div class="segvalue emd-thumb"><a title="<?php echo get_the_title(); ?>" href="<?php echo esc_url(get_permalink($post->ID)); ?>"><?php echo emd_featured_img('', 'thumbnail', 'wp_easy_events'); ?></a></div>
</div>
</li>
<?php
		} ?>
...
<div class="segtitle" style="margin-bottom:0;"></div>
<div class="segvalue"><i aria-hidden="true" class="fa fa-link fa-fw"></i><a title='Link' target='_blank' href='<?php echo esc_html(emd_mb_meta('emd_eo_website', '', $myrel->ID)); ?>' title='<?php echo get_the_title(); ?>'><?php esc_html_e('Click for more info', 'wp-easy-events'); ?></a></div>
</div>
</li>
<?php
		} ?>
...
<?php $post = get_post();
	...
	$rel_list = get_option('wp_easy_events_rel_list');
?>
<div class="single-relpanel emd-event-venues event-venue"><div class="accor-title"><?php esc_html_e('Venue', 'wp-easy-events'); ?></div>  <?php
	echo $res['before_list'];
	$real_post = $post;
	$rel_count_id = 1;
	$rel_eds = Array();
