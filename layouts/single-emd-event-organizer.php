...
?>
<div class="single-relpanel emd-wpe-event event-organizer"><div class="accor-title"><?php esc_html_e('Events', 'wp-easy-events'); ?></div>  <?php
...
<div class="segtitle" style="margin-bottom:0;"></div>
<div class="segvalue"><i aria-hidden="true" class="fa fa-link fa-fw"></i><a title='Link' target='_blank' href='<?php echo esc_html(emd_mb_meta('emd_event_external_url', '', $myrel->ID)); ?>' title='<?php echo get_the_title(); ?>'><?php esc_html_e('Click for more info', 'wp-easy-events'); ?></a></div>
</div>
</li>
<?php
		} ?>
