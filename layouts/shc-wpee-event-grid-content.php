...
global $wpee_event_grid_count, $wpee_event_grid_filter, $wpee_event_grid_set_list;
$real_post = $post;
$ent_attrs = get_option('wp_easy_events_attr_list');
?>
<a href="<?php echo esc_url(get_permalink()); ?>" style="text-decoration:none" title="<?php echo get_the_title(); ?>">
