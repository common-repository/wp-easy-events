    ...
    <table id="eventticket" class="noborder">
        <tbody>
            <tr>
                ...
                <td class="noborder"><?php esc_html_e('Ticket ID', 'wp-easy-events'); ?>:</td>
            ...
            <tr>
                <td class="noborder"><?php esc_html_e('First Name', 'wp-easy-events'); ?>: </td>
                <td class="noborder"><strong><?php echo esc_html(emd_mb_meta('emd_attendee_first_name')); ?>
</strong></td>
            </tr>
            <tr>
                <td class="noborder"><?php esc_html_e('Last Name', 'wp-easy-events'); ?>: </td>
                <td class="noborder"><strong><?php echo esc_html(emd_mb_meta('emd_attendee_last_name')); ?>
</strong></td>
            </tr>
            <tr>
                <td class="noborder"><?php esc_html_e('Email', 'wp-easy-events'); ?>:</td>
                <td class="noborder"><strong><?php echo esc_html(emd_mb_meta('emd_attendee_email')); ?>
</strong></td>
            </tr>
            <tr>
                <td class="noborder"><?php esc_html_e('Quantity', 'wp-easy-events'); ?>:</td>
